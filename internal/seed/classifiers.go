...
func SeedAllClassifiers(ctx context.Context, q studiodb.Querier) error {
	steps := []struct {
		...
		{"project_stage", []classifierRow{
			{Code: "inquiry", Title: "Inquiry"},
			{Code: "queue", Title: "Queue"},
			{Code: "working", Title: "Working"},
			{Code: "review", Title: "Review"},
			{Code: "completed", Title: "Completed"},
		}},
		{"priority", []classifierRow{
			{Code: "standard", Title: "Standard"},
			{Code: "high", Title: "High"},
			{Code: "urgent", Title: "Urgent"},
		}},
		{"treatment_method", []classifierRow{
			{Code: "surface_cleaning", Title: "Surface cleaning"},
			{Code: "consolidation", Title: "Consolidation"},
			{Code: "varnish_removal", Title: "Varnish removal"},
			{Code: "retouching", Title: "Retouching"},
			{Code: "structural_repair", Title: "Structural repair"},
		}},
	}
